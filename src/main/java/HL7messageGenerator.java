...
public class HL7messageGenerator {
    ...
    public String generateHL7Message(PersonInfo personInfo) {
        ...
        try {
            ...
            // Populate the MSH Segment (unchanged)
            ...
            // Populate the EVN Segment (unchanged)
            ...
            // Populate the PID Segment (unchanged)
            PID pid = adt.getPID();
            ...
            pv1Segment.getPv11_SetIDPV1().setValue("1");
            pv1Segment.getPatientClass().setValue("I"); // Inpatient
            pv1Segment.getAssignedPatientLocation().getPl1_PointOfCare().setValue("ICU"); // Intensive Care Unit
            // You can populate other fields in PV1 based on your needs
